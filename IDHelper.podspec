...
Pod::Spec.new do |s|
  s.name             = 'IDHelper'
  s.version          = '0.1.0'
  s.summary          = 'A short description of IDHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/IDHelper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ivanov Developer' => 'ivanov.developer@mail.ru' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/IDHelper.git', :tag => s.version.to_s }
